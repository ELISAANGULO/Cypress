        ...
        context('When I write and login in the page', () => {
            ...
            it('Should be the process',()=>{
                ...
                for(i; i< 9; i++){
                    ...
                    cy.get('textarea[class="gh-editor-title ember-text-area gh-input ember-view"]').type(generateRandomString(7)+generateRandomString(6)).clear()
                    cy.wait(1000)
